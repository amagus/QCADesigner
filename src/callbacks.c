...
static void reset_single_cell_cb (DESIGN *design, QCADDesignObject *obj, gpointer data) ;
...
//SARDINHA - Reset option
void reset_selection_menu_item_activate (GtkWidget *widget, gpointer user_data)
{
    selection_renderer_draw (project_options.srSelection, project_options.design, main_window.drawing_area->window, GDK_XOR) ;
    design_selection_objects_foreach (project_options.design, reset_single_cell_cb, NULL) ;
    selection_renderer_update (project_options.srSelection, project_options.design) ;
    selection_renderer_draw (project_options.srSelection, project_options.design, main_window.drawing_area->window, GDK_XOR) ;
}
